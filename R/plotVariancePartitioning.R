...
plotVariancePartitioning = function(VP){
   ...
   barplot(VP$vals,main=paste("Variance partitioning. R2(traits) = ", round(VP$traitR2,2),".", sep=""),xlab = "Species", ylab = "Variance proportion", legend=leg, col =  heat.colors(ng, alpha = 1))
}
