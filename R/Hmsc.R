...
#' @param XSelect is a list describing how variable selection is to be applied
...
#' @param TrFormula a formula-class object for regression dependence of \eqn{B_{kj}} coefficeints on species traits
