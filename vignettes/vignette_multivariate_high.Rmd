...
As expected, both traits exhibit a clear phylogenetic signal, i.e. related species show similar trait values.
...
postBeta = getPostEstimate(m, parName = "Mean")
...
postGamma = getPostEstimate(m, parName = "Mean")
