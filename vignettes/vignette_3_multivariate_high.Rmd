...
```{r P1, fig.height=4, fig.width=4, fig.cap="\\label{fig: XXX} Histogram of species-specific r2 values"}
XFormula.1 = ~poly(climate, degree = 2, raw = TRUE)
...
```{r P2, fig.height=4, fig.width=10, fig.cap="\\label{fig: XXXII} Effects of prior shrinkage values on inferred residual associations"}
